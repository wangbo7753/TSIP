    ...
    return {    	
        ...
        createTab: function (tabId, dir, tabName) {
            if ($('#' + tabId).length == 0) {
                ...
                $('#' + tabId).append('<iframe scrolling="auto" frameborder="0" src="./' + dir + '/' + tabId + '.html" style="width:100%;height:'+(document.documentElement.clientHeight-109)+'px;overflow:hidden;"></iframe>');
            }
